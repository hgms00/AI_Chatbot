...
from .DataNode import AtomNode, ConnectorNode, ConnectorType, NegativeNode
from .reader.RuleControl import OPERATORS, ImplicationType
...
class NPIDataTree(DataTree):
    def __init__(self, npi_rules, facts, queries):
        super(NPIDataTree, self).__init__()
    ...
    def set_atoms_relations(self, rules):
        if self.atoms.__len__() is 0:
            raise BaseException("The DataTree is empty")
